/**
 * TODO: Add integration tests for iptorrents. Need a logon so not sure if this is going to be possible.
 */
...
// test('iptorrents tv has sonarr icon', async ({ page }) => {
//   await page.goto('https://www.iptorrents.com/tv/fringe', { waitUntil: 'commit' });
...
// test('iptorrents movie has radarr icon', async ({ page }) => {
//   await page.goto('https://www.iptorrents.com/m/the_dark_knight', { waitUntil: 'commit' });
//   await expect(page.locator(iconDataLocator)).toHaveCount(1);
