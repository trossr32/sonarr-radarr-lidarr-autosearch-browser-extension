...
test('letterboxd movie has radarr icon', async ({ page }) => {
  await page.goto('https://letterboxd.com/film/the-dark-knight/', { waitUntil: 'networkidle' });
...
test('letterboxd movie has sonarr icon', async ({ page }) => {
  await page.goto('https://letterboxd.com/film/chernobyl/', { waitUntil: 'networkidle' });
