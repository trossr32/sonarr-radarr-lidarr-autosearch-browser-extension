(function () {
    ...
    var ImdbEngine = DefaultEngine({
        ...
        resolveSiteType: function (document /*, url, settings */) {
            ...
            var rules = [
                { siteId: 'sonarr', pattern: /(video\.tv_show|tv_show|tvseries|tv)/i },
                { siteId: 'radarr', pattern: /(video\.movie|movie|film)/i }
            ];
    ...
    window.__servarrEngines.list.push(ImdbEngine);
})();
